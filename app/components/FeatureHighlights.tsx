...
export default function FeatureHighlights() {
  const features = [
    {
      icon: <Smartphone className="w-10 h-10 text-blue-500 mb-4" />,
      title: "端末込みの実質料金診断",
      description:
        "SIMのみ、購入型、返却型まで条件ごとに最適プランを提案。端末代込みで本当のコストが分かります。",
    },
    {
      icon: <TrendingUp className="w-10 h-10 text-blue-500 mb-4" />,
      title: "経済圏・ポイント還元も考慮",
      description:
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-gray-50 to-white">
      <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">
        私たちの診断が選ばれる<span className="text-blue-500">3つの理由</span>
      </h2>
