...
import { filterByInternetSet } from "../../utils/filters/filterByInternetSet";
...
const testAnswers: Partial<Phase2Answers> = {
  ...
  mainCard: ["クレジットカード"],
  overseasSupport: "はい",
  setDiscount: "光回線の契約, ルーター購入・レンタル, ポケットWi-Fi契約",
  fiberType: "戸建て",
  fiberSpeed: "1Gbps以上",
  routerCapacity: "〜20GB",
  routerSpeed: "最大1Gbps",
...
// 💡 セット割適用候補
// ===================================================
const fiberResult = filterByInternetSet(testAnswers as Phase2Answers, fiberPlans);
