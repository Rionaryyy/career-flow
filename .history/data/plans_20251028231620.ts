...
voicemailFee: 330,
  ...
  // === 📆 ソフトバンク 月60分無料 ===
  {
    ...
    callMonthlyLimit: 60,
    callIncluded: false,
    supportsInternationalUnlimitedCalls: false, // 🈚️ 非対応
    callOptions: [
      { id: "none", name: "なし", fee: 0 },
      { id: "monthly30", name: "月30分無料", fee: 550 },
      { id: "monthly60", name: "月60分無料", fee: 770 },
    ],
    internationalCallFee: 0, // 🈚️
// ソフトバンク（softbank）
...
voicemailFee: 300,
  ...
  // === 🔁 au ハイブリッド（30回×10分） ===
  {
    ...
    tetheringFee: 330,
    hasVoicemail: true,
     supportsInternationalUnlimitedCalls: true, // ✅ au対応
    callOption: true,
    callType: "hybrid",
    callCountLimit: 30,
    callPerCallLimit: 10,
...
voicemailFee: 200,
    ...
    internationalCallFee: 900, // 🈶 国際通話定額：900円/月
    ageDiscountRules: [
  ...
  // === 🌐 楽天 無制限かけ放題 ===
  {
    ...
    tetheringFee: 0,
    hasVoicemail: true,
    supportsInternationalUnlimitedCalls: true, // ✅ 楽天対応
    callOption: false,
    callType: "unlimited",
    callIncluded: true,
    ...
    internationalCallFee: 980, // 🈶 国際通話かけ放題：980円/月
    // 楽天モバイル（rakuten）
// → 留守番電話機能は標準提供（無料）
voicemailFee: 0,
