...
export const allPlans: Plan[] = [
  // === 🕐 ドコモ 5分かけ放題 ===
  {
    ...
    subscriptionDiscountRules: [
      {
        id: "sub_docomo_dtv",
        applicableSubscriptions: ["dTV", "dアニメストア", "dマガジン"],
        discount: 300,
      },
    ],
  ...
  // === 📆 ソフトバンク 月60分無料 ===
  {
    ...
    subscriptionDiscountRules: [
      {
        id: "sub_softbank_yahoo",
        applicableSubscriptions: ["Yahoo!プレミアム", "LINE MUSIC"],
        discount: 200,
      },
    ],
  ...
  // === 🔁 au ハイブリッド（30回×10分） ===
  {
    ...
    subscriptionDiscountRules: [
      {
        id: "sub_au_telasa",
        applicableSubscriptions: ["TELASA（テラサ）", "U-NEXT"],
        discount: 300,
      },
    ],
  ...
  // === 🌐 楽天 無制限かけ放題 ===
  {
    ...
    subscriptionDiscountRules: [
      {
        id: "sub_rakuten_tv_music",
        applicableSubscriptions: ["Rakuten TV", "Rakuten Music"],
        discount: 200,
      },
    ],
