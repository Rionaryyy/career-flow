...
export const allPlans: Plan[] = [
 ...
 /**
 * ===================================================
 * 📦 devicePrices.ts から自動で返却プログラム情報を紐付け
 * ---------------------------------------------------
 * 今後複数端末対応のため、model/storage指定も考慮可能。
 * selectedModel / selectedStorage を利用する場合、
 * 条件に追加すれば特定端末の比較も可能。
 * ===================================================
 */
