              ...
              <div className="mt-4 text-sm text-gray-700">
                ...
                <div className="mt-2">
                  ...
                  <p className="text-xs text-gray-500 ml-3">
                    ↳ 総額: ¥{plan.breakdown.cashbackTotal?.toLocaleString()} /{" "}
                    月割: ¥{plan.breakdown.cashback?.toLocaleString()}
                  </p>
                </div>
                ...
                <div className="mt-1">
                  ...
                  <p className="text-xs text-gray-500 ml-3">
                    ↳ 総額: ¥{plan.breakdown.initialCostTotal?.toLocaleString()}
                  </p>
                </div>
                ...
                {plan.breakdown.deviceLeaseMonthly &&
                  plan.breakdown.deviceLeaseMonthly > 0 && (
                    <div className="mt-1">
                      ...
                      <p className="text-xs text-gray-500 ml-3">
                        ↳ 総額（目安）:
                        ¥{plan.breakdown.deviceTotal?.toLocaleString()}
                      </p>
                    </div>
                  )}
