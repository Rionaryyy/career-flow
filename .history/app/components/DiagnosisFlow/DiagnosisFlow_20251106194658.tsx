...
// 🟦 各セクション
import Phase1 from "./BaseConditions";
import Phase2Data from "./Data";
import Phase2Call from "./Call";
import Phase2Contract from "./Contract";
import Phase2Ecosystem from "./Ecosystem";
import Phase2Subscription from "./Subscription";
import Phase2Device from "./Device";
import Phase2Overseas from "./Overseas";
import Phase2Payment from "./Payment";
