  ...
  const handleChange = (
    ...
    if (id === "needCallPlan" && value === "no") {
      onChange({
        ...
        callOptionsNeeded: null, // ✅ 空文字ではなくnull
        needInternationalCallUnlimited: "",
        internationalCallCarrier: [], // ✅ 型 string[] に対応
    ...
    // 🟨 「アドバイス経由で“はい”を選んだ後に“いいえ”に戻す」パターンもリセット
    if (id === "needCallPlanConfirm" && value === "no") {
      onChange({
        needCallPlanConfirm: "no",
        callPlanType: [],
        timeLimitPreference: "",
        monthlyLimitPreference: "",
        hybridCallPreference: "",
