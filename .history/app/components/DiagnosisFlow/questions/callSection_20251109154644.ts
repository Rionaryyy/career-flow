...
export const callQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "無制限（完全かけ放題）", value: "unlimited" },
    ],
    condition: (ans: DiagnosisAnswers) =>
  ...
  },
{
  ...
  type: "radio" as const,
  options: [
    { label: "月30分まで無料", value: "monthly30min" },
    { label: "月60分まで無料", value: "monthly60min" },
    { label: "月70分まで無料", value: "monthly70min" },
    { label: "月100分まで無料", value: "monthly100min" },
...

  {
    ...
    type: "radio" as const,
    options: [
      { label: "月30回まで各10分無料（よくある定番タイプ）", value: "30x10min" },
      { label: "月50回まで各10分無料（通話回数が多い方向け）", value: "50x10min" },
