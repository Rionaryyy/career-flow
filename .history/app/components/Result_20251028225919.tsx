          ...
          {rankedResults.map((plan, index) => (
            ...
            >
              ...
              <div className="mt-4 text-sm text-gray-700">
                ...
                {plan.internationalCallFee && plan.internationalCallFee > 0 &&
 answers.phase2?.needInternationalCallUnlimited === "はい" &&
 answers.phase2?.internationalCallCarrier?.some((c) => c.includes(plan.carrier)) && (
  <p>・海外通話オプション: +¥{plan.internationalCallFee}</p>
)}
