...
export interface CallOption {
  id: string;
  /** 追加: 通話オプションの種別 ("time" | "monthly" | "hybrid" | "unlimited") */
  type?: "time" | "monthly" | "hybrid" | "unlimited";
  name: string;
  fee: number;
}
...
carrierSpecific?: CarrierSpecific; // ← これ！
  ...
  deviceModel?: string; // ✅ カンマ区切りの対応機種リスト
...
export interface CarrierSpecific {
  carrier: string;
  studentDiscount_Under18?: string;
  studentDiscount_Under22?: string;
  youthDiscount_Under22?: string;
  youthDiscount_Under25?: string;
  youthDiscount_Under29only?: string;
  seniorDiscount_Over60?: string;
  familyDiscount_2?: string;
  familyDiscount_3?: string;
  familyDiscount_4?: string;
  familyDiscount_5?: string;
  voicemailFee?: string;
  paymentEligibleMethods?: string;
  goldCardAnnualFee?: string;
  carrierShoppingRewardRate_Yahoo?: string;
  carrierShoppingRewardRate_LOHACO?: string;
  carrierShoppingRewardRate_Rakuten?: string;
  carrierShoppingRewardRate_AUPayMarket?: string;
  id?: string;
}
