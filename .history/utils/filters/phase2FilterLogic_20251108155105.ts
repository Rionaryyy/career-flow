...
if (answers.dataUsage) {
  const usage = answers.dataUsage?.toString().toLowerCase() ?? "";
  let minRequired = 0;
  let isUnlimited = false;

  if (usage.includes("無制限") || usage.includes("unlimited")) {
    isUnlimited = true;
  } else if (usage.includes("50") && usage.includes("gb")) {
    minRequired = 50;
  } else if (usage.includes("30") && usage.includes("gb")) {
    minRequired = 30;
  } else if (usage.includes("20") && usage.includes("gb")) {
    minRequired = 20;
  } else if (usage.includes("10") && usage.includes("gb")) {
    minRequired = 10;
  } else if (usage.includes("5") && usage.includes("gb")) {
    minRequired = 5;
  } else if (usage.includes("3") && usage.includes("gb")) {
    minRequired = 3;
  }
