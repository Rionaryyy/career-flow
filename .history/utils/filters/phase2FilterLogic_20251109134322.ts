...
// ===================================================
// 📞 国内通話プランフィルター（UI質問準拠・unlimited上位互換対応版）
// ===================================================
      ...
      const newMatches = filtered.filter((p) =>
        p.callOptions?.some((opt) => {
          ...
          return (
            ...
            (opt.type === "unlimited") ||
            (pref === "unlimited" && ["time", "unlimited"].includes(opt.type))
          );
        })
      );
      ...
      const newMatches = filtered.filter((p) =>
        p.callOptions?.some((opt) => {
          ...
          return (
            ...
            (opt.type === "unlimited") ||
            (pref === "unlimited" && ["monthly", "unlimited"].includes(opt.type))
          );
        })
      );
        ...
        p.callOptions?.some((opt) => {
          ...
          return (
            (opt.type === "hybrid" &&
              ...
              def.perCall >= perCall) ||
            (opt.type === "unlimited") ||
            (pref === "unlimited" && ["hybrid", "unlimited"].includes(opt.type))
          );
        })
      );
