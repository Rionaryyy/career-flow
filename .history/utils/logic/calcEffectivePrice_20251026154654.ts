...
console.log("🧩 buyingDevice:", buyingText);
console.log("🧩 selectedModel:", answers.phase2?.deviceModel);
console.log("🧩 selectedStorage:", answers.phase2?.deviceStorage);
